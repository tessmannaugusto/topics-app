...
- [x] **Task AQG-1: Update Topic Schema**
...
- [x] **Task AQG-2: Create Question Generation Schema**
...
- [x] **Task AQG-3: Implement Question Generation Endpoint**
...
- [x] **Task AQG-4: Implement Question Generation Logic**
...
- [x] **Task AQG-6: Add "Regenerate" Functionality**
