...
- [x] **Task IR-1: Implement Answer Input UI**
...
- [x] **Task IR-2: Implement Answer Persistence**
...
- [x] **Task IR-3: Integrate Voice Recording for Answers**
...
- [x] **Task IR-4: Call Transcription for Voice Answers**
...
- [x] **Task IR-5: Add "Answered" Status Indicator**
